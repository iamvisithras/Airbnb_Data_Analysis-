...
def datafr():
    df= pd.read_csv("C:\guvi\project\guvi project\Airnbn _Analysis\Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open(r"C:\guvi\project\guvi project\Airnbn _Analysis\AIRBNB.jfif")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab1:
        ...
        with tab2:
            ...
            def datafr():
                df_a= pd.read_csv("C:\guvi\project\guvi project\Airnbn _Analysis\Airbnb.csv")
                return df_a
